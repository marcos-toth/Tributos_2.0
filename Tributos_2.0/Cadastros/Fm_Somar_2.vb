...
Public Class Fm_Somar_2

    Private Sub Fm_Somar_2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnSalvar_Click(sender As Object, e As EventArgs) Handles btnSalvar.Click
        Fm_Cadastro_Pagamentos_Realizados.Chek_Varios.Checked = False
        Fm_Cadastro_Pagamentos_Realizados.TxtPago.Text = Lbl_Total.Text
        Fm_Cadastro_Pagamentos_Realizados.TxtPago.Select()
        Fm_Cadastro_Pagamentos_Realizados.Soma()
        Me.Dispose()
