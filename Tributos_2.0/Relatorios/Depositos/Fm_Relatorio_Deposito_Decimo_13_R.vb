Public Class Fm_Relatorio_Deposito_Decimo_13_R

    Private Sub Fm_Relatorio_Deposito_Decimo_13_R_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            Else
                ...
                End If
            End If
            Me.Report_13.LocalReport.SetParameters(New Microsoft.Reporting.WinForms.ReportParameter("Usuario", NomeUsuario))
            Me.Report_13.RefreshReport()
