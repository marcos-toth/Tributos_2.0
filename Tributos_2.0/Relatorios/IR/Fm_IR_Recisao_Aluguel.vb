...
Public Class Fm_IR_Recisao_Aluguel

    Private Sub Fm_IR_Recisao_Aluguel_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnRelatorio_Click(sender As Object, e As EventArgs) Handles btnRelatorio.Click
        ...
        If Rb_RelatorioGeral.Checked = True Then
            TipoRel = "1"
            Cabecalho = "Relatório Anual - " & vlAno
        ElseIf Rb_RelatorioGeralAnualEntidade.Checked = True Then
            TipoRel = "2"
            Cabecalho = "Relatório Anual " & Cb_EntidadeMae.Text & " - " & vlAno
        ElseIf Rb_RelatorioGeralMensal.Checked = True Then
            TipoRel = "3"
            Cabecalho = "Relatório Mensal - " & vlMes & "/" & vlAno
        ElseIf Rb_RelatorioGeralMensalEntidade.Checked = True Then
            TipoRel = "4"
            Cabecalho = "Relatório " & Cb_EntidadeMae.Text & " - " & vlMes & "/" & vlAno
        End If
        
        Fm_IR_Recisao_Aluguel_R.Show()
    End Sub
