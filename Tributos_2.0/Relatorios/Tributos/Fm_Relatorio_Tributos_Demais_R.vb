Public Class Fm_Relatorio_Tributos_Demais_R

    Private Sub Fm_Relatorio_Tributos_Demais_R_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            Else
                ...
                End If
            End If
            Me.Report_Tributos_Demais.LocalReport.SetParameters(New Microsoft.Reporting.WinForms.ReportParameter("PeriodoCompetencia", VPeriodo))
            Me.Report_Tributos_Demais.LocalReport.SetParameters(New Microsoft.Reporting.WinForms.ReportParameter("Usuario", NomeUsuario))
            Me.Report_Tributos_Demais.RefreshReport()
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub

    Private Sub Report_Tributos_Demais_Load(sender As Object, e As EventArgs) Handles Report_Tributos_Demais.Load
