Public Class Fm_Relatorio_Tributos_FGTS_R

    Private Sub Fm_Relatorio_Tributos_FGTS_R_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            Else
                ...
                End If
            End If
            Me.Report_Tributo_FGTS.LocalReport.SetParameters(New Microsoft.Reporting.WinForms.ReportParameter("PeriodoCompetencia", VPeriodo))
            Me.Report_Tributo_FGTS.LocalReport.SetParameters(New Microsoft.Reporting.WinForms.ReportParameter("Usuario", NomeUsuario))
            Me.Report_Tributo_FGTS.RefreshReport()
